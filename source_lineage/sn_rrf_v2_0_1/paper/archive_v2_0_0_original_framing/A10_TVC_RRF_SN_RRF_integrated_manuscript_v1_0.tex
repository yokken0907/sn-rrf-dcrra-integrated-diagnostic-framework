...
\title{Scale-Normalized Residual Response Family for SPARC Galaxy Rotation-Curve Residuals:\\
From A10/TVC-RRF Fixed-Kernel Diagnostics to Dimensionless Manifold and Kernel-Family Synthesis}
\author{Keiji Yoshimura\\Independent Researcher}
\date{May 2026\\\vspace{0.25em}\small DOI: \href{https://doi.org/10.5281/zenodo.20224479}{10.5281/zenodo.20224479}\\\small GitHub: \href{https://github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}{github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}}

\begin{document}
\maketitle

\begin{abstract}
We present an integrated, claim-bounded diagnostic audit of a residual-response structure in SPARC galaxy rotation curves. The project begins by reformulating a pre-A10/TVC radial ansatz as A10/TVC-RRF, an A10/TVC-inspired Residual Response Field, and then generalizes it beyond the original fixed-exponent framing into SN-RRF, a Scale-Normalized Residual Response Family. The retained kernel class is diagnostic only: it is not proposed as a dark-matter replacement, a Lambda-CDM replacement, a MOND/RAR falsification, a Bullet-Cluster explanation, a proof of a physical TVC mechanism, or a solution to the Hubble tension. In the full eligible SPARC population of 143 galaxies, A10/TVC-RRF shows persistent residual-response signal relative to baryonic-fit and RAR-like comparators, including a RAR-relative median $\dAIC(\mathrm{TVC\mbox{-}RRF}-\mathrm{RAR\mbox{-}like})=-33.482$ and a beats-RAR fraction of 0.867. The best interpretable population relation is between RRF amplitude and maximum rotation velocity, with Spearman $\rho=0.873$ and permutation $p=0.001996$. Subsequent beyond-A10 stages show that a strict rectangular dimensionless normal band is inconclusive, but a weaker central-manifold plus pathology-separation moat interpretation is supported and stable under bootstrap and permutation controls. Curve-level null-refit controls show that the locked fixed-exponent kernel beats destructive nulls in 91.6\% of galaxies, while neighboring monotone-saturating kernels compete. A continuous exponent scan over 41 grid points gives best-$n$ median 2.25 and IQR [1.5, 3.2545], rejecting fixed-exponent uniqueness while supporting a heterogeneous, scale-normalized monotone-saturating residual-response family. We conclude that SN-RRF is supported as a diagnostic residual-response family and pathology-separation framework under the tested protocol, with no physical-promotion claim.
\end{abstract}
...
The surviving structure is not a proof of a physical medium. It is a residual-response family with three diagnostic properties:
\begin{enumerate}
...
The practical meaning is simple: the old fixed-exponent ansatz should not be treated as a new physical law, but the residual-response geometry it exposed is useful enough to merit a new diagnostic theory language.
...
\section{Conclusion}
This integrated audit supports a conservative but nontrivial conclusion. A10/TVC-RRF survives as a fixed-kernel diagnostic representative, but fixed-exponent uniqueness does not survive. The better final synthesis is SN-RRF: a Scale-Normalized Residual Response Family for SPARC galaxy rotation-curve residuals.

SN-RRF is supported as a diagnostic residual-response family and pathology-separation framework under the tested protocol. It is not evidence for dark-matter exclusion, Lambda-CDM replacement, MOND/RAR defeat, a Bullet-Cluster explanation, a physical TVC mechanism, or a Hubble-tension solution.

\section*{Code and Artifact Availability}
The integrated artifact record is archived at Zenodo DOI \href{https://doi.org/10.5281/zenodo.20224479}{10.5281/zenodo.20224479}. The corresponding GitHub repository is intended to be hosted at \href{https://github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}{github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}. The repository package contains the manuscript sources, result summaries, figures, scripts, claim-boundary material, and browser-only project visual orientation files.
...
Yoshimura, K. (2026). A10/TVC-RRF Galaxy Residual Diagnostic artifacts. Zenodo. DOI: \href{https://doi.org/10.5281/zenodo.20224479}{10.5281/zenodo.20224479}.

\bibitem{Yoshimura2026GitHub}
Yoshimura, K. (2026). A10/TVC-RRF Galaxy Residual Diagnostic repository. GitHub. \href{https://github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}{github.com/yokken0907/a10-tvc-rrf-galaxy-residual-diagnostic}.
\end{thebibliography}
