...
\title{Dark-Component Residual Response Audit:\\
A Claim-Bounded Diagnostic Map of SPARC Galaxy Rotation-Curve Residual Regimes}
\author{Keiji Yoshimura\\Independent Researcher}
\date{May 2026\\\vspace{0.5em}\small Repository DOI: \href{https://doi.org/10.5281/zenodo.20233908}{10.5281/zenodo.20233908}\\\small GitHub repository: \url{https://github.com/yokken0907/dark-component-residual-response-audit}}
\begin{document}
\maketitle

\begin{abstract}
This paper presents the Dark-Component Residual Response Audit (DCRRA), a claim-bounded diagnostic audit of dark-component-like residuals in SPARC galaxy rotation-curve data \cite{lelli2016}. The study does not attempt to identify a dark-matter particle, exclude dark matter, replace $\Lambda$CDM, falsify MOND/RAR \cite{milgrom1983,mcgaugh2016}, falsify NFW halos \cite{nfw1997}, explain the Bullet Cluster, or solve the Hubble tension. Instead, it asks a narrower diagnostic question: whether galaxy-scale residuals that are often interpreted as dark-component-like can be decomposed into multiple residual regimes using the previously developed SN-RRF parent result \cite{yoshimura2026snrrf}, NFW-like \cite{nfw1997} and RAR-like \cite{mcgaugh2016} comparators, nuisance/pathology pass-through classes, proxy association audits, and destructive/constructive null controls.

Across 143 eligible SPARC galaxies, DCRRA constructs a seven-zone residual-regime map. The final map contains 54 response-family-dominant galaxies, 23 response-family with NFW-competitive galaxies, 6 halo-comparator-dominant galaxies, 16 mixed three-way competitive galaxies, 30 nuisance-sensitive galaxies, 12 pathology/archive galaxies, and 2 unresolved triangular cases. The response-family-associated zones contain 77 galaxies, while pathology or nuisance pass-through classes contain 42 galaxies. DCRRA6 null controls reject destructive shuffled-label/proxy nulls in 4/4 tests and obtain nontrivial proxy-only reconstruction signals, with accuracy 0.314685 and balanced accuracy 0.328735. DCRRA8 locks the synthesis with 9/9 guards passed.

The safe conclusion is that dark-component-like SPARC rotation-curve residuals are not monolithic under this diagnostic protocol. They can be represented as a residual-regime map containing response-family-like, halo-comparator-like, mixed, nuisance-sensitive, pathology/archive, and unresolved zones. This is a diagnostic taxonomy, not a causal physical classification and not a dark-matter replacement claim.
\end{abstract}

\section{Scope and claim boundary}
DCRRA is built as a diagnostic taxonomy/audit of galaxy-scale residuals in the SPARC rotation-curve context \cite{lelli2016}. Its central purpose is to separate residual regimes, not to infer the physical identity or non-existence of dark matter. The following claims are explicitly outside the scope of this manuscript:
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\linewidth]{figs/dcrra_zone_counts.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\linewidth]{figs/dcrra_zone_median_best_n.png}
...
\section*{Repository and archival DOI}
\sloppy
The repository package associated with this manuscript is archived on Zenodo. DOI: \href{https://doi.org/10.5281/zenodo.20233908}{10.5281/zenodo.20233908}. GitHub repository: \url{https://github.com/yokken0907/dark-component-residual-response-audit}. This archival reference is provided for reproducibility, provenance, and citation of the public release package \cite{yoshimura2026dcrra}; it does not broaden the claim boundary beyond the diagnostic residual-regime map stated in the main text.
\fussy
...
\bibitem{yoshimura2026dcrra} K. Yoshimura, Dark-Component Residual Response Audit: A Claim-Bounded Diagnostic Map of SPARC Galaxy Rotation-Curve Residual Regimes, independent manuscript and repository package (2026). DOI: \href{https://doi.org/10.5281/zenodo.20233908}{10.5281/zenodo.20233908}. GitHub repository: \url{https://github.com/yokken0907/dark-component-residual-response-audit}.
